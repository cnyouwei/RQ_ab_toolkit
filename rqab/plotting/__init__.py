...
Pure plotting layer: existing CSVs/tables or deterministic analytic curves
in, figures out.  Simulation and grid stages are run by the CLI/reproduce
...
first_calibration  standardized first-RQ b_k(q) calibration figures
